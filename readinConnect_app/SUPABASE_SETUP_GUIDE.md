...
> Complete step-by-step guide to set up Supabase for ReadinConnect

---

## 🎯 Overview

This guide walks you through setting up Supabase for the ReadinConnect literacy learning platform, including:
...
**Prerequisites:** None (Supabase is free!)
...
**Success:** You should see the Supabase dashboard for your new project!
...
3. **Link your local project to Supabase:**
   ...
   ```
   (Find your project ID in the dashboard URL: `supabase.com/dashboard/project/YOUR_PROJECT_ID`)
...
1. In the Supabase dashboard, click **Settings** in the left sidebar
...
**Replace:**
- `https://xxxxxxxxx.supabase.co` with your actual Project URL
...
2. Check Project URL format: `https://xxxxx.supabase.co`
3. Ensure project is active (not paused in Supabase dashboard)
...
2. Enable real-time for your tables:
   ...
   - `earned_badges`
   - `reward_points`
3. Use the `supabase.realtime` client in your code
...
- **Quick Start:** https://supabase.com/docs/guides/getting-started/nextjs
...
Once Supabase is set up, ReadinConnect will have:
...
*Created: 2026-02-07*
*Purpose: Complete Supabase setup guide for ReadinConnect*
*Version: 1.0.0*
